...
public class NewGameDisplay extends GraphicsObject {
	...
	public NewGameDisplay(Context context, PlayerInfo playerInfo) {
		...
		currentLevel = new Label("Level: " + playerInfo.getLevel(), 0.5f,
				0.68f, context);
		currentLevel.setAlignment(Alignment.CENTER_HORIZONTALLY);
		checkpointLevel = new Label("Checkpoint Level: "
				+ playerInfo.getCheckpointLevel(), 0.5f, 0.28f, context);
	...
	public void draw(Canvas c) {
		...
		checkpointLevel.setText("Checkpoint Level: "
				+ playerInfo.getCheckpointLevel());
