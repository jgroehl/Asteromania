...
public class GameOverDisplay extends GraphicsObject
{
	...
	public GameOverDisplay(Context context, PlayerInfo playerInfo, Highscore highscore)
	{
		super(0, 0, 1, 1, context);

		gameOverTextPaint = new Label(context.getResources().getString(de.jgroehl.asteromania.R.string.game_over),
				0.1f, 0.3f, context);
		...
		newHighscoreLabel = new Label(context.getResources().getString(de.jgroehl.asteromania.R.string.new_highscore)
				+ "!", 0.2f, 0.6f, context);
	...
	public void draw(Canvas c)
	{
		...
		scorePaint.setText(getContext().getResources().getString(de.jgroehl.asteromania.R.string.your_score) + ": "
